...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <?php 
        $link = $_SERVER['PHP_SELF'];//getting the current link
        $linkArray = explode('/',$link);//transforming the link into the array
        $page = end($linkArray);
      ?>
      ...
      ?>">
        ...
        <div class="input-group input-group-sm">
          <input class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search" name="searchName">
